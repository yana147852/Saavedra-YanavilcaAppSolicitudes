...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        if (mediaFileUri == null) {
            ...
            RequestBody correoPart = RequestBody.create(MultipartBody.FORM, nombre);
            RequestBody tipo_solicitudPart = RequestBody.create(MultipartBody.FORM, solicitud);
            RequestBody solicitudPart = RequestBody.create(MultipartBody.FORM, detalles);

            call = service.createMatriculaWithImage(correoPart, tipo_solicitudPart, solicitudPart, imagenPart);
        }
